  ...
  return (
    <div>
      <div className="container mx-auto mt-10">
        <div className="lg:flex shadow-lg rounded-lg border lg:h-48 h-full mb-4 mx-auto">
          <div>
            <div className="text-white bg-brand-6 border-2 rounded-b-lg md:rounded-r-lg md:h-full lg:w-40 h-20 shadow-inner flex justify-center items-center">
              <div className="text-center flex md:flex-col items-center">
                <div className="text-white md:mt-0 xl:h-12  font-bold text-5xl md:text-7xl p-1 leading-8">
                  <SiOpenapiinitiative />
                </div>
              </div>
            </div>
          ...
          <div className="ml-auto">
            <div
              ...
              className="hover:border-brand-4 hover:bg-white hover:text-brand-4 text-white bg-brand-6 border-2 rounded-b-lg md:rounded-r-lg md:h-full lg:w-40 h-20 shadow-inner flex justify-center items-center"
            >
              <div className="text-center flex md:flex-col items-center">
                <div className=" xl:h-12  font-bold md:text-7xl text-5xl p-1 leading-8 cursor-pointer">
                  <IoIosAddCircleOutline />
                </div>
                <p className="md:mt-8 text-lg">Start Project</p>
              </div>
            </div>
          </div>
        </div>
