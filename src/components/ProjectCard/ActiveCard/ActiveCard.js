		...
		<div>
			<div className='container mx-auto mt-10'>
				<div className='lg:flex shadow-lg rounded-lg border lg:h-48 h-full   mb-4 mx-auto transition duration-500 ease-in-out transform hover:-translate-y-2 hover:shadow-2xl'>
					<div>
						<div className='bg-brand-4 rounded-t-lg md:rounded-l-lg md:h-full h-20 lg:w-40 shadow-inner flex justify-center items-center md:pb-8'>
					...
					<div className='ml-auto'>
						<div
							...
							className='hover:border-brand-7 hover:bg-white hover:text-brand-7 text-white bg-brand-4 border-2 rounded-b-lg md:rounded-r-lg md:h-full lg:w-40 h-20 shadow-inner flex justify-center items-center'
						>
							<div className='text-center flex md:flex-col items-center'>
								...
								<p className='md:mt-8 text-lg'>Finish Project </p>
							</div>
						</div>
					</div>
				</div>
